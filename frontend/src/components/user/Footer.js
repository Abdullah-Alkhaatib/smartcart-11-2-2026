    ...
    <footer className="site-footer" dir="rtl">
      <div className="site-footer__container">
        <div className="site-footer__grid">
          <div className="site-footer__brand">
            ...
            <p className="site-footer__text">
              متجر إلكتروني سريع وبسيط يوفر أفضل المنتجات بأسعار مناسبة وتجربة
              شراء مريحة.
            </p>
          </div>
          ...
          <div className="site-footer__section">
            ...
            <div className="site-footer__qr-wrapper">
              <p className="site-footer__qr-text">
                اضغط مطولًا لنسخ رابط الموقع
              </p>
              <a
                href={siteUrl}
                target="_blank"
        ...
        <div className="site-footer__bottom">
          <p className="site-footer__developer">Developer Abdullah Mohammed</p>
